...
/*
     FILE ARCHIVED ON 16:30:13 Feb 16, 2016 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 12:41:23 Dec 13, 2016.
...
*/
/*!
 * jQLite JavaScript Library v1.1.1 (/web/20160216163013/http://code.google.com/p/jqlite/)
 * Copyright (c) 2010 Brett Fattori (bfattori@gmail.com)
 * Licensed under the MIT license
 * /web/20160216163013/http://www.opensource.org/licenses/mit-license.php
 *
 * Many thanks to the jQuery team's efforts.  Some code is
 * Copyright (c) 2010, John Resig.  See
 * /web/20160216163013/http://jquery.org/license
 *
...
(function() {
  this.Dosbox = (function() {
    ...
    Dosbox.prototype.downloadScript = function() {
      ...
      return new Dosbox.Xhr('/web/20160216163013/https://js-dos.com/cdn/js-dos.js', {
        success: (function(_this) {
...
(function() {
  Dosbox.UI = (function() {
    function UI(options) {
      ...
      this.overlay.append($('<div class="dosbox-powered">Powered by &nbsp;').append($('<a href="/web/20160216163013/http://js-dos.com">js-dos.com')));
